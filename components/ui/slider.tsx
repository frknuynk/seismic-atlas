...
function Slider({
  ...
  return (
    <SliderPrimitive.Root
      className={cn(
        'cursor-pointer data-disabled:cursor-not-allowed data-horizontal:w-full data-vertical:h-full',
        className,
      )}
      data-slot="slider"
      ...
      {...props}
    >
      <SliderPrimitive.Control className="data-vertical:min-h-40 relative flex w-full cursor-pointer touch-none items-center select-none active:cursor-grabbing data-disabled:cursor-not-allowed data-disabled:opacity-50 data-vertical:h-full data-vertical:w-auto data-vertical:flex-col">
